export const PatientFormSection = () => {
  return (
    <aside
      ...
      role="complementary"
      aria-label="Patient form navigation"
    >
      <button
      ...
      <h1 className="absolute top-[610px] left-[-82px] rotate-[-90.00deg] [font-family:'Noto_Sans_Lao_ExtraCondensed-Light',Helvetica] font-light text-transparent text-[26.2px] tracking-[1.84px] leading-[normal]">
        <span className="text-black tracking-[0.48px]">問診票入力 </span>
