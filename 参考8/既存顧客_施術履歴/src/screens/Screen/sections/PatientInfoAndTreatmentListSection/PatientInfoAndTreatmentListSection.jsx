export const PatientInfoAndTreatmentListSection = () => {
  return (
    <aside
      ...
      role="complementary"
      aria-label="Patient information sidebar"
    >
      <button
      ...
      <p className="absolute top-[587px] left-[-105px] rotate-[-90.00deg] [font-family:'Noto_Sans_Lao_ExtraCondensed-Light',Helvetica] font-light text-transparent text-[26.2px] tracking-[1.84px] leading-[normal]">
