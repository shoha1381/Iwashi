export const AppointmentTimeSection = () => {
  const staffMembers = [
    { name: "野明みゆ", number: "③" },
    { name: "岩中貴俊", number: "①" },
    { name: "近藤美華", number: "②" },
  ...
  return (
    <header className="fixed top-[-284px] left-[346px] w-[141px] h-[834px] flex items-end justify-end bg-white overflow-hidden rotate-[90.00deg] shadow-[0px_2px_4px_#00000026,inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_1px_rgba(0,0,0,0.13),inset_-1px_0_1px_rgba(0,0,0,0.11)] backdrop-blur-[2.0px] backdrop-brightness-[100.0%] backdrop-saturate-[100.0%] [-webkit-backdrop-filter:blur(2.0px)_brightness(100.0%)_saturate(100.0%)]">
      <div className="mb-[377.0px] w-[834px] mr-[-362.0px] flex rotate-[-90.00deg]">
        ...
        <nav
          className="inline-flex w-[769px] h-20 relative items-center"
          role="navigation"
