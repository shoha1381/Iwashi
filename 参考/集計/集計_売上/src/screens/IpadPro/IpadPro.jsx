...
export const IpadPro = () => {
  const [selectedType, setSelectedType] = useState("売上");
  ...
  return (
    ...
    >
      ...
      <main className="fixed top-[167px] left-[calc(50.00%_-_373px)] w-[746px] h-[648px] z-[2] flex flex-col">
        <section className="h-44 relative bg-[#ffffff73] rounded-[20px] border-[0.91px] border-solid border-[#ffffff1a] shadow-[0px_0px_15px_#00000012] backdrop-blur-[12.27px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(12.27px)_brightness(100%)]">
              ...
              {typeOptions.map((type, index) => (
                <button
                  ...
                  className={`absolute top-0.5 ${
                    ...
                    selectedType === type ? "justify-center bg-[#4aa9fc]" : ""
        ...
        <img
          className="ml-0.5 w-[744px] h-[329px] mt-[51px] aspect-[2.26] object-cover"
          alt="集計データ表"
          src="/img/cleanshot-2025-10-28-at-16-44-43-2x-1.png"
        />
      </main>
      ...
      >
        {navigationItems.map((item, index) => {
          const positions = [
            { top: 716, left: 22, iconTop: 84, textTop: 92 },
            { top: 211, left: 23, iconTop: 211, textTop: 219 },
            { top: 339, left: 23, iconTop: 339, textTop: 346 },
            { top: 466, left: 25, iconTop: 466, textTop: 471 },
            { top: 589, left: 22, iconTop: 589, textTop: 597 },
            { top: 716, left: 22, iconTop: 716, textTop: 723 },
          ];
                      ...
                      : index === 2
                        ...
                        : index === 3
                          ...
                          : index === 4
                            ? "top-[219px]"
                            : "top-[92px]"
                } left-[59px] h-[19px] flex items-center justify-center rotate-[-90.00deg] [font-family:'Noto_Sans_JP',Helvetica] font-medium ${
