...
export const IpadPro = () => {
  const [selectedCategory, setSelectedCategory] = useState("施術");
  ...
  const [selectedStaff, setSelectedStaff] = useState("伊藤彰吾");
  ...
  const navigationItems = [
    { id: "settings", icon: "/img/vector-4.svg", label: "設定", active: false },
    {
      id: "customers",
    ...
    { id: "revenue", icon: "/img/vector-5.svg", label: "売上", active: false },
    {
      id: "analysis",
      icon: "/img/frame-517.svg",
      label: "分析",
      active: false,
    },
    {
  ...
  return (
    ...
    >
      ...
      <main className="fixed top-[167px] left-[calc(50.00%_-_373px)] w-[747px] h-[738px] z-[2] flex flex-col">
        <section
          className="w-[746px] h-44 relative bg-[#ffffff73] rounded-[20px] border-[0.91px] border-solid border-[#ffffff1a] shadow-[0px_0px_15px_#00000012] backdrop-blur-[12.27px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(12.27px)_brightness(100%)]"
          aria-label="フィルターパネル"
        >
          ...
          <div className="absolute top-3 left-[calc(50.00%_-_318px)] w-[637px] h-[154px]">
            ...
            <div
              className="absolute top-2.5 left-[57px] w-[210px] h-[47px] bg-white rounded-[23.44px] shadow-[inset_0px_0px_7.81px_#00000026,inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_1px_rgba(0,0,0,0.11),inset_-1px_0_1px_rgba(0,0,0,0.09)] backdrop-blur-[1.6px] backdrop-brightness-[100.0%] backdrop-saturate-[100.0%] [-webkit-backdrop-filter:blur(1.6px)_brightness(100.0%)_saturate(100.0%)]"
              role="group"
              aria-label="カテゴリー選択"
            >
                ...
                <button
                  ...
                  className={`absolute top-0.5 ${
                    ...
                    category.label === selectedCategory
                      ? "justify-center bg-[#4aa9fc]"
                      : "justify-center"
                  } rounded-[21.1px] overflow-hidden`}
            ...
            <button
              className="absolute w-[20.09%] h-[30.52%] top-[62.99%] left-[8.95%] flex gap-[15.2px] bg-white rounded-[8.81px] shadow-[0px_0px_7.81px_#00000026]"
              aria-label={`店舗選択: ${selectedStore}`}
            >
            ...
            <label className="absolute top-[88px] left-[316px] h-[66px] flex items-center justify-center [font-family:'Noto_Sans_JP',Helvetica] font-medium text-black text-[13px] tracking-[0.91px] leading-[65.6px] whitespace-nowrap">
              スタッフ
            </label>

            <button
              className="absolute top-[97px] left-[389px] w-[142px] h-[47px] flex gap-[15.4px] bg-white rounded-[8.81px] shadow-[0px_0px_7.81px_#00000026]"
              aria-label={`スタッフ選択: ${selectedStaff}`}
            >
              <span className="flex items-center justify-center mt-[13.6px] w-[57px] h-[21px] ml-[27.6px] [font-family:'Noto_Sans_JP',Helvetica] font-normal text-black text-[13.4px] tracking-[0.94px] leading-[20.5px] whitespace-nowrap">
                {selectedStaff}
              </span>
            ...
            <button
              className="absolute top-[9px] left-[389px] w-32 h-[47px] flex gap-[13.2px] bg-white rounded-[8.81px] shadow-[0px_0px_7.81px_#00000026]"
              aria-label={`年選択: ${selectedYear}`}
            >
            ...
            <button
              className="absolute top-[9px] left-[526px] w-[111px] h-[47px] flex gap-[12.4px] bg-white rounded-[8.81px] shadow-[0px_0px_7.81px_#00000026]"
              aria-label={`月選択: ${selectedMonth}`}
            >
        ...
        <img
          className="w-[747px] h-[417px] mt-[53px] aspect-[1.79] object-cover"
          alt="集計結果テーブル"
          src="/img/cleanshot-2025-10-28-at-16-41-12-2x-1.png"
        />
      </main>
      ...
      >
        {navigationItems.map((item, index) => {
          ...
          return (
            <div key={item.id}>
              <button
                className={`absolute ${positions[index].top} ${positions[index].left} ${
                  item.id === "revenue"
                    ? "w-[31px] h-[31px]"
                    : "w-[35px] h-[35px]"
                } rotate-[-90.00deg] ${item.id !== "analysis" ? "aspect-[1]" : ""}`}
              ...
              >
                ...
                {item.id === "treatment-nav" && (
                  <>
                    <div className="absolute w-[35px] h-[35px] aspect-[1]">
                      <img
                        className="absolute w-[83.33%] h-[83.33%] top-[8.33%] left-[8.33%]"
                        alt=""
                        src={item.icon}
                      />
                      <img
                        className="absolute w-[83.33%] h-[25.00%] top-[16.66%] left-[8.33%]"
                        alt=""
                        src={item.icon2}
                      />
                    </div>
              ...
              <span
                className={`absolute ${labelPositions[index].top} ${labelPositions[index].left} h-[19px] flex items-center justify-center rotate-[-90.00deg] [font-family:'Noto_Sans_JP',Helvetica] font-medium ${
