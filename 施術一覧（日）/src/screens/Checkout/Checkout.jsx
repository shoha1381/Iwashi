...
export const Checkout = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 via-neutral-100 to-blue-50 flex items-center justify-center p-6 font-sans">
            {/* Modal Container */}
            <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className={`relative w-12 h-7 rounded-full transition-colors ${surveyDiscount ? 'bg-blue-500' : 'bg-neutral-300'
                                        }`}
                                >
                                    <span
                                        className={`absolute top-1 w-5 h-5 bg-white rounded-full shadow transition-transform ${surveyDiscount ? 'right-1' : 'left-1'
                                            }`}
                                    />
                                </button>
                ...
                <div className="px-6 pb-6 flex gap-3">
                    ...
                    <button className="flex-1 py-3 bg-blue-500 text-white text-sm font-medium rounded-full hover:bg-blue-600 transition-colors">
                        支払い確定
                    </button>
                </div>
            </div>
