...
// Icon Components
const SettingsIcon = () => (
  <svg className="side-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ScheduleGridSection = () => {
  ...
  const navigationItems = [
    ...
    { id: "customers", icon: <UsersIcon />, label: "顧客" },
    { id: "summary", icon: <ChartIcon />, label: "集計" },
    { id: "sales", icon: <CurrencyIcon />, label: "売上" },
    { id: "analysis", icon: <AnalyticsIcon />, label: "分析" },
