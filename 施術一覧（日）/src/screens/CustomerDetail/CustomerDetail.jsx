...
export const CustomerDetail = () => {
    ...
    return (
        <div className="min-h-screen bg-neutral-100 flex font-sans overflow-x-hidden">
            {/* Side Navigation */}
            <ScheduleGridSection />
            ...
            <div className="flex-1 flex flex-col lg:mr-16 pb-20 lg:pb-0 w-full h-screen overflow-auto">
                ...
                <header className="bg-white border-b border-neutral-200 px-6 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <span className="text-lg text-neutral-600">2025/10/06</span>
                        <span className="text-sm text-neutral-400">月</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="text-sm text-neutral-600">銀座店</span>
                        <button className="px-4 py-1.5 bg-blue-500 text-white text-sm rounded-full">日</button>
                        <button className="px-4 py-1.5 bg-neutral-200 text-neutral-600 text-sm rounded-full">週</button>
                    </div>
                </header>
                ...
                <div className="p-6">
                    <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden">
                        ...
                        <div className="flex justify-end p-3">
                            <Link to="/customers" className="p-2 hover:bg-neutral-100 rounded-lg transition-colors">
                                <CloseIcon />
                            </Link>
                        </div>
                        ...
                        <div className="px-6 pb-6 flex gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2 mb-4">
                                    <button className="w-10 h-10 flex items-center justify-center bg-green-500 text-white rounded-xl">
                                        <DocumentIcon />
                                    </button>
                                    <button className="w-10 h-10 flex items-center justify-center bg-yellow-400 text-white rounded-xl">
                                        <AIIcon />
                                    </button>
                                    <button className="w-10 h-10 flex items-center justify-center bg-red-500 text-white rounded-xl">
                                        <TrashIcon />
                                    </button>
                                    <button className="w-10 h-10 flex items-center justify-center bg-blue-500 text-white rounded-xl">
                                        <EditIcon />
                                    </button>
                                </div>
                                ...
                                <div className="flex items-center gap-2 mb-2">
                                    <span className={`px-2 py-0.5 ${mockCustomerDetail.labelColor} text-white text-xs rounded`}>
                                ...
                                <div className="flex gap-4 mb-4">
                                    <div className="flex-1">
                                        <h3 className="text-sm font-medium text-neutral-600 mb-1">目標</h3>
                                        <p className="text-sm text-neutral-800 bg-neutral-50 p-3 rounded-lg">
                                            {mockCustomerDetail.target}
                                        </p>
                                    </div>
                                    <div className="w-48">
                                        <h3 className="text-sm font-medium text-neutral-600 mb-1">注意事項</h3>
                                        <p className="text-sm text-neutral-800 bg-neutral-50 p-3 rounded-lg whitespace-pre-line">
                        ...
                        <div className="px-6 pb-6 flex justify-end gap-3">
                            <button className="px-6 py-2 bg-blue-500 text-white text-sm font-medium rounded-full hover:bg-blue-600 transition-colors">
                                施術
                            </button>
                            <button className="px-6 py-2 bg-neutral-200 text-neutral-700 text-sm font-medium rounded-full hover:bg-neutral-300 transition-colors">
                                週
                            </button>
                        </div>
                    </div>
